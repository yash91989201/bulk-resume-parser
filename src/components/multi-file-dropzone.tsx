...
import { formatFileSize, formatSecondsToMinutes } from "@/lib/utils";
import {
  CheckCircleIcon,
  FileIcon,
  LucideFileWarning,
          ...
          ({ file, abortController, progress, estimatedTimeRemaining }, i) => (
            ...
            >
              <div className="flex items-center gap-2 text-gray-500 dark:text-white">
                ...
                <div className="grow" />
                <div className="flex w-32 justify-end text-xs">
                  {progress === "PENDING" ? (
                    <button
                      type="button"
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <span>
                          {estimatedTimeRemaining !== undefined &&
                            `Estd. ${formatSecondsToMinutes(estimatedTimeRemaining)}`}
                        </span>
                      </div>
                    </div>
                  ) : (
