...
async def download_txt_file(file_path: str) -> str:
    """
    Downloads a TXT file from MinIO to the local directory.
...
async def upload_txt_file(local_txt_path: str, user_id: str, task_id: str) -> str:
    """
    Uploads a .txt file to MinIO processed-txt-files bucket.
